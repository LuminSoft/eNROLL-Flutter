...
A new Flutter plugin project.
  ...
  s.dependency 'dot-face-detection-fast', '= 7.5.1'
  s.dependency 'dot-face-background-uniformity', '= 7.5.1'
  s.dependency 'dot-face-expression-neutral', '= 7.5.1'
  s.dependency 'dot-document', '= 7.5.1'
  s.dependency 'Flutter'
  s.platform = :ios, '11.0'
