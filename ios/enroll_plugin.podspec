...
A new Flutter plugin project.
  ...
  s.dependency 'dot-face-detection-fast', '= 8.7.0'
  s.dependency 'dot-face-background-uniformity', '= 8.7.0'
  s.dependency 'dot-face-expression-neutral', '= 8.7.0'
  s.dependency 'dot-document', '= 8.7.0'
  s.dependency 'Flutter'
  s.platform = :ios, '11.0'
